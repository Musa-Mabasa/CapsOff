...
import 'package:stem_wiz/src/tips_and_tricks/choose_topic.dart';
import '../group_selection/group_selection.dart';

void main() => runApp(const MaterialApp(home: Admin()));

class TipsConceptSelection extends StatefulWidget {
  const TipsConceptSelection({Key? key}) : super(key: key);

  @override
  TipsConceptSelectionState createState() => TipsConceptSelectionState();
}

class TipsConceptSelectionState extends State<TipsConceptSelection> {
  @override
